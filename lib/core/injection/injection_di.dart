...
import 'package:spm/features/injection/data/data_sources/flutter_analyze_data_source_impl.dart';
import 'package:spm/features/injection/data/data_sources/injection_data_source.dart';
import 'package:spm/features/injection/data/data_sources/injection_data_source_impl.dart';
import 'package:spm/features/injection/data/data_sources/run_app_data_source.dart';
import 'package:spm/features/injection/data/data_sources/run_app_data_source_impl.dart';
import 'package:spm/features/injection/data/repositories/flutter_analyze_repository_impl.dart';
import 'package:spm/features/injection/data/repositories/injection_repository_impl.dart';
import 'package:spm/features/injection/data/repositories/run_app_repository_impl.dart';
...
import 'package:spm/features/injection/domain/use_cases/flutter_analyze_use_case.dart';
import 'package:spm/features/injection/domain/use_cases/inject_use_case.dart';
import 'package:spm/features/injection/domain/use_cases/run_with_injection_use_case.dart';
...
class InjectionDI {
  ...
  static FlutterAnalyzeRepository get flutterAnalyzeRepository =>
      _flutterAnalyzeRepository ??= FlutterAnalyzeRepositoryImpl(flutterAnalyzeDataSource);

  static FlutterAnalyzeUseCase get flutterAnalyzeUseCase =>
      _flutterAnalyzeUseCase ??= FlutterAnalyzeUseCase(flutterAnalyzeRepository);
