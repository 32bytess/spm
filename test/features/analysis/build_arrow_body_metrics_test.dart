...
void main() {
  ...
  group('expression-bodied build()', () {
    test('arrow body returning const widget sets rootBuildReturnsConstWidget', () {
      ...
      expect(
        ...
        equals(0),
        reason: 'the only widget is const, so it is excluded from the '
  ...
  group('const returns inside closures (depth guard)', () {
    test('builder closures returning const do not set rootBuildReturnsConstWidget',
        () {
      final r = results.firstWhere(
